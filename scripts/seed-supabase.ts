...
const AUDIT_EVENTS = [
  ...
  { event_id: 'EVT-MoUD-006-ZKP', event_type: 'ZKP_VERIFIED', topic: 'bid.zkp', timestamp_ist: '2025-03-11T14:02:30+05:30', data: { tender_id: 'TDR-MoUD-2025-000006', actor: 'BLOCKCHAIN', actor_role: 'SYSTEM', blockchain_tx: '0xc9d3e6f8a1b4c7d0', block_number: 1332, commitment_verified: true, description: 'SHA-256 commitment verified on-chain for Smart City Bhopal bid' } },
