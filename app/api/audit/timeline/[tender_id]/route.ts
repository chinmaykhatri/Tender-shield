...
const AIIMS_TIMELINE = [
  ...
  { time: '14:22 IST', date: '2025-03-27', actor: 'healthcare@healthcareindia.com', role: 'BIDDER', action: 'BID_COMMITTED', details: 'HealthCare India commits ZKP bid (commitment: 0xa3f2...)', blockchain_tx: '0x2e5c7d1a4b3f6e8d9c0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1b1d', risk_at_time: 0 },
  { time: '16:58:15 IST', date: '2025-03-27', actor: 'admin@biomedicorp.com', role: 'BIDDER', action: 'BID_COMMITTED', details: 'BioMed Corp commits ZKP bid — company registered 30 days ago', blockchain_tx: '0x1d4e3f2a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c3f6a', risk_at_time: 0 },
  { time: '16:59:02 IST', date: '2025-03-27', actor: 'admin@pharmaplus.com', role: 'BIDDER', action: 'BID_COMMITTED', details: 'Pharma Plus commits ZKP bid (47 seconds after BioMed Corp)', blockchain_tx: '0x9c2e7f1a3b4d5e6f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d7f1a', risk_at_time: 45 },
  { time: '17:00:00 IST', date: '2025-03-27', actor: 'AI_SYSTEM', role: 'SYSTEM', action: 'BIDS_REVEALED', details: 'Deadline passed — all 3 bids auto-revealed via ZKP verification', blockchain_tx: '0x7b3d5c2e1f4a6b8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b5c2e', risk_at_time: 45 },
